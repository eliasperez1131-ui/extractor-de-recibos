...
Section "Instalar Extractor de Recibos" SecMain
    ...
    WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\Extractor de Recibos" "DisplayVersion" "1.0.3.0"
